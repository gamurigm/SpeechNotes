...
\begin{tcolorbox}[enhanced, breakable, colback=white, colframe=critica,
  ...
  title={\textbf{CP-03} \enspace Iniciar y detener grabaci\'on \hfill \prioChip{critica}{Cr\'itica} \enspace \statusChip{falla-red}{FALLADO}},
  fonttitle=\color{white},
  attach boxed title to top left={yshift=-2mm,xshift=4mm},
...
\begin{itemize}[noitemsep,topsep=2pt]
  ...
  \item[$\times$] Error en consola: ``No se encontr\'o la referencia'' (BUG-002)
\end{itemize}
\end{minipage}
\end{tcolorbox}
...
\begin{tcolorbox}[enhanced, breakable, colback=white, colframe=espe-blue,
  boxrule=1pt, arc=5pt,
  title={\textbf{CP-05} \enspace Upload de audio para transcribir \hfill \prioChip{alta}{Alta} \enspace \statusChip{falla-red}{FALLADO}},
  fonttitle=\color{white},
  attach boxed title to top left={yshift=-2mm,xshift=4mm},
  boxed title style={colback=espe-blue,arc=3pt}]
\begin{minipage}[t]{0.48\linewidth}
...
\begin{itemize}[noitemsep,topsep=2pt]
  ...
  \item[$\times$] Aparece texto de ayuda incorrecto en el modal (BUG-009)
\end{itemize}
\end{minipage}
\end{tcolorbox}
...
\begin{tcolorbox}[enhanced, breakable, colback=white, colframe=espe-blue,
  boxrule=1pt, arc=5pt,
  title={\textbf{CP-07} \enspace Editar y guardar una transcripci\'on \hfill \prioChip{media}{Media} \enspace \statusChip{falla-red}{FALLADO}},
  fonttitle=\color{white},
  attach boxed title to top left={yshift=-2mm,xshift=4mm},
  boxed title style={colback=espe-blue,arc=3pt}]
\begin{minipage}[t]{0.48\linewidth}
...
\begin{itemize}[noitemsep,topsep=2pt]
  ...
  \item[$\times$] Error grave al guardar transcripci\'on con texto muy largo (BUG-005)
\end{itemize}
\end{minipage}
\end{tcolorbox}
...
\begin{tcolorbox}[colback=row-alt, colframe=espe-blue, boxrule=0.8pt, arc=3pt,
  ...
  boxed title style={colback=espe-blue}]
\begin{itemize}
  \item \textbf{CP-03} (Grabaci\'on) fall\'o por BUG-002 (Error en consola: ``No se encontr\'o la referencia'').
  \item El flujo cr\'itico \textbf{CP-04} (Transcripci\'on en vivo) pas\'o satisfactoriamente.
  \item \textbf{CP-05} (Upload) fall\'o por BUG-009 (Texto de ayuda incorrecto en modal).
  \item \textbf{CP-07} (Editar y guardar) fall\'o por BUG-005 (Error al guardar con texto largo).
  \item \textbf{CP-09} queda pendiente por dependencia de credenciales IA locales; se retomar\'a en el re-testing del D\'ia 3.
  \item Los defectos BUG-01 a BUG-04, BUG-05 (Major), BUG-09 ser\'an registrados en Jira con evidencia para su correcci\'on en el c\'odigo en el pr\'oximo sprint de desarrollo.
\end{itemize}
\end{tcolorbox}
